...
| :--- | :--- | :--- | :--- | :--- |
| **Domain, Grid, and Layers (10 Points)** | Model domain, grid spacing ($\Delta x=\Delta y=50\text{ m}$) and  ($\Delta x=10\text{ m}$) and ($\Delta y=50\text{ m}$) at the river, and single-layer unconfined aquifer are all implemented correctly. | Minor errors in domain size or grid spacing. Aquifer setup is mostly correct. | Significant errors in model domain or grid setup, or incorrect layer type used. | Model domain, grid, and layer setup are fundamentally incorrect or missing. |
...
| **Hyraulic Head Simulation (60 Points)** | Successful model runs with all the required figures and tables shown  | Successful model runs with all most the required figures and tables shown | Successful model runs with only a few figures shown| Unscessful model run. |    
...
| Criteria | Excellent (100-90%) | Proficient (89-75%) | Developing (74-60%) | Unsatisfactory (<60%) |
| :--- | :--- | :--- | :--- | :--- |
| **Scenario Setup and Execution (10 Points)** | All scenarios for the chosen problem are set up correctly (e.g., pumping well location, industrial area recharge changes, particle tracking setup). Model runs are executed correctly. | Scenarios are set up with minor errors (e.g., incorrect recharge value, wrong drawdown constraint). | Major errors in scenario setup that prevent a meaningful analysis. | Scenarios are not set up or are fundamentally flawed. |
...
| Criteria | Excellent (100-90%) | Proficient (89-75%) | Developing (74-60%) | Unsatisfactory (<60%) |
| :--- | :--- | :--- | :--- | :--- |
| **Structure & Completeness** | The report follows the suggested outline precisely and includes all required sections. The narrative is logical, coherent, and provides comprehensive information. | The report includes most required sections, but the structure may be disorganized, or some information is missing. | The report is missing multiple key sections or is poorly structured. | The report is incomplete and does not follow the required structure. |
| **Quality of Figures & Tables** | All required figures are included, are of publication quality, and are clearly labeled, referenced, and explained in the text [cite: 170-182]. | All required figures are present but may lack professional quality, clear labels, or sufficient explanation. | Several required figures are missing, or the included figures are low quality and not explained. | Figures are largely absent or irrelevant. |
| **Discussion & Professionalism** | The report presents a clear and insightful discussion of the results, assumptions, and model limitations. The writing is professional, concise, and free of grammatical errors. | The discussion of results is adequate but may lack depth or critical analysis of limitations. Some grammatical errors are present. | The discussion is superficial, and the report is difficult to read due to poor writing and grammatical errors. | The report lacks any meaningful discussion, and the writing is unprofessional. |
